...
//        posts = [post0, post1, post2, post3, post4]
        ...
        let task = URLSession.shared.dataTask(with: URL(string: "https://www.flickr.com/services/rest/?method=flickr.photos.search&format=json&safe_search=3&nojsoncallback=1&api_key=e33dc5502147cf3fd3515aa44224783f&tags=cat")!, completionHandler: { (data, response, error) -> Void in
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let task = URLSession.shared.downloadTask(with: post.imageURL, completionHandler: { (url, response, error) -> Void in
